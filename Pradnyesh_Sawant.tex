...
\cvitem {\textbf{Mobile}}{Cordova, expo, react-native (via Clojurescript)}
...
\cvitem {}{
\begin{itemize}
\item Single-handedly built and delivered an hybrid mobile app + backend + cloud hosting and storage from scratch in 5 months
\item Trained 9 engineering freshers on FP and clj(s) in 2 months
...
\cventry {16/02--Present}{Head of Engineering}{http://mindseed.in}
         ...
         {At Mindseed Preschool, the best preschool in India, we believe in personalizing education for every child. This vision can only be realized at scale via technology; where my contribution is
           ...
           \item also, being the part of Senior Management, I also contribute in organization level planning and implementation
           \end{itemize}}
