...
\cvitem {}{
\begin{itemize}
\item Built the first BAU Games in flipkart with 165k simultaneous users and 1.39M gameplays in a single day
...
\item Registered and setup a software development company and built product using machine learning (ML) technologies and functional programming
...
%%          {}
\cventry {-- 12/Mar}{Autos, Cars}{http://autos.yahoo.com/news/} %, http://uk.cars.yahoo.com/motorshow/frankfurt/}
         {Team size: 6+5}{}
