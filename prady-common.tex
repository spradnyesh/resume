...
%----------------------------------------------------------------------------------------
\section{Skillset}
\cvitem {Languages}{Clojure, Clojurescript, Common Lisp, Java, PHP, Javascript, Python, Bash, Latex}
\cvitem {Data mining}{Weka, Encog (Clojure with Java interop)}
\cvitem {Cloud/VPS}{Redhat OpenShift, Linode (debian with root access)}
\cvitem {Frameworks}{Luminus (Clojure), Restas (Common Lisp), Spring (J2EE)}
...
\cvitem {Databases}{MongoDB, MySQL, PostgreSQL, SQLite3}
...
\begin{itemize}
  ...
  \item Selected for sponsored project for Network Simulator in Java, sponsored by NICT, Japan, from IITG
\end{itemize}}
...
\cventry {Apr '2012 -- Present}{Solo-preneur (stox.gryff.in)}{}
